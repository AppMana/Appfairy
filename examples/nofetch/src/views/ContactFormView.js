  ...
  render() {
    ...
    return (
      <div className="__af-div-block">
        <h3 className="__af-heading-7">
          Looking for a <strong>FREE</strong> <br />
          phone consultation?
        </h3>
        <div className="__af-w-form">
          <form
            ...
            redirect="/thank-you"
          >
            <label htmlFor="name" className="__af-field-label">
              Name:
            </label>
            {proxies["name"] && (
              <input
                type="text"
                className="__af-w-input"
                maxLength={256}
                name="name"
                data-name="Name"
                ...
                {...proxies["name"]}
              >
                {proxies["name"].children}
              </input>
            )}
            <label htmlFor="Phone" className="__af-field-label-2">
              Email Address:
            </label>
            <input
              type="text"
            ...
            <textarea
              ...
              maxLength={5000}
              data-name="Message"
              className="__af-textarea __af-w-input"
              defaultValue={""}
            />
            {proxies["submit"] && (
              <input
                ...
                className="__af-button __af-w-button"
                {...proxies["submit"]}
              >
                {proxies["submit"].children}
              </input>
            )}
          </form>
