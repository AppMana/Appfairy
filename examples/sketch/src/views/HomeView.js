...
const scripts = [
  ...
  Promise.resolve(
    'window.animaShowOverlay=void 0!==window.animaShowOverlay?window.animaShowOverlay:function(e,a){e="overlay-"+e,-1==document.getElementById(e).className.split(" ").slice(-1)[0].lastIndexOf("an-animation-")&&(document.getElementById(e).className=document.getElementById(e).className+" "+a)},window.animaHideOverlay=void 0!==window.animaHideOverlay?window.animaHideOverlay:function(e,a){e="overlay-"+e;var n=document.getElementById(e).className.split(" ");-1!=n.slice(-1)[0].lastIndexOf("an-animation-")&&(n.splice(-1),n.push(a),document.getElementById(e).className=n.join(" "),n.splice(-1),setTimeout(function(){document.getElementById(e).className=n.join(" ")},1100))};',
  ),
];
        ...
        <span className="af-view">
          ...
          >
            <div className="af-class-bp2-grid-layout-container">
              <div className="af-class-bp2-grid">
                    ...
                    {props.children ? (
                      ...
                      <React.Fragment>
                        <div
                          ...
                          className="af-class-bp2-cell bp2-an-animation-enter "
                        >
                          <img
                            anima-src="./img/homecontent@2x.png"
                            className="af-class-bp2-content"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                          />
                          <div className="af-class-bp2-overlay">
                            <div className="af-class-bp2-white-overlay"></div>
                ...
                <a href="projectpage.html">
                  <div
                    anima-show-on-scroll
                    className="af-class-bp2-view1 bp2-an-animation-enter1 "
                  >
                    <img
                      anima-src="./img/homecontent  1@2x.png"
                      className="af-class-bp2-image1"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <div className="af-class-bp2-view2">
                      <div className="af-class-bp2-view3"></div>
                ...
                <a href="projectpage.html">
                  <div
                    anima-show-on-scroll
                    className="af-class-bp2-view4 bp2-an-animation-enter2 "
                  >
                    <img
                      anima-src="./img/homecontent  2@2x.png"
                      className="af-class-bp2-image2"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <div className="af-class-bp2-view5">
                      <div className="af-class-bp2-view6"></div>
                  ...
                  <a {...props}>
                    {props.children ? (
                      ...
                      <React.Fragment>
                        <div
                          anima-show-on-scroll
                          className="af-class-bp2-view7 bp2-an-animation-enter3 "
                        >
                          <img
                            anima-src="./img/homecontent  3@2x.png"
                            className="af-class-bp2-image3"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                          />
                          <div className="af-class-bp2-view8">
                            <div className="af-class-bp2-view9"></div>
                  ...
                  <a {...props}>
                    {props.children ? (
                      ...
                      <React.Fragment>
                        <div
                          anima-show-on-scroll
                          className="af-class-bp2-view10 bp2-an-animation-enter4 "
                        >
                          <img
                            anima-src="./img/homecontent  4@2x.png"
                            className="af-class-bp2-image4"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                          />
                          <div className="af-class-bp2-view11">
                            <div className="af-class-bp2-view12"></div>
                ...
                <a href="projectpage.html">
                  <div
                    anima-show-on-scroll
                    className="af-class-bp2-view13 bp2-an-animation-enter5 "
                  >
                    <img
                      anima-src="./img/homecontent  5@2x.png"
                      className="af-class-bp2-image5"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <div className="af-class-bp2-view14">
                      <div className="af-class-bp2-view15"></div>
            ...
            <div className="af-class-bp2-my-work-layout-container">
              <div
                anima-show-on-scroll
                className="af-class-bp2-my-work bp2-an-animation-enter6 "
              >
                - MY WORK -
              </div>
            </div>
            <div className="af-class-bp2-keep-in-touch-layout-container">
              <div
                anima-show-on-scroll
                className="af-class-bp2-keep-in-touch bp2-an-animation-enter7 "
              >
                - KEEP IN TOUCH -
              </div>
            </div>
            <div className="af-class-bp2-top-bar-bg"></div>
            <div className="af-class-bp2-header-layout-container">
              <div className="af-class-bp2-header">
                <div className="af-class-bp2-cover-bg"></div>
                <img
                  anima-src="./img/homecover image.jpg"
                  className="af-class-bp2-cover-image"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <div className="af-class-bp2-hello-box bp2-an-animation-enter8 ">
                  <div className="af-class-bp2-background"></div>
                  <img
                    anima-src="./img/homecorner@2x.png"
                    className="af-class-bp2-corner"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  ...
                  <div className="af-class-bp2-i-m">I'M</div>
                </div>
            ...
            {map(proxies["menu"], (props) => (
              <a {...props}>
                {props.children ? (
                  ...
                  <React.Fragment>
                    <img
                      anima-src="./img/project page mobilemenubutton@2x.png"
                      className="af-class-bp2-menu-button bp2-an-animation-enter11 "
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </React.Fragment>
                )}
            ...
            <div className="af-class-bp2-footer-layout-container">
              <div className="af-class-bp2-footer">
                <div className="af-class-bp2-footer-bg"></div>
                ...
                <a href="tel:+1-800-555-123456">
                  <div className="af-class-bp2-phone">1.800.555.123456</div>
                </a>
                <div className="af-class-bp2-social">
                  <a href="https://twitter.com/AnimaApp" target="_blank">
                    <img
                      anima-src="./img/homedribbble@2x.png"
                      className="af-class-bp2-dribbble"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </a>
                  <a
                    href="https://facebook.com/groups/animaapp/"
                    target="_blank"
                  >
                    <img
                      anima-src="./img/homebehance@2x.png"
                      className="af-class-bp2-behance"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </a>
                  <a
                  ...
                  >
                    <img
                      anima-src="./img/homefacebook@2x.png"
                      className="af-class-bp2-facebook"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </a>
                  <a href="https://twitter.com/AnimaApp">
                    <img
                      anima-src="./img/hometwitter@2x.png"
                      className="af-class-bp2-twitter"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </a>
                </div>
                ...
                <div className="af-class-bp2-form">
                  <div className="af-class-bp2-top-fields">
                    <input
                      className="af-class-bp2-text-name"
                      name="textName"
                      placeholder="Name"
                    />
                    <input
                      className="af-class-bp2-text-email"
                      name="textEmail"
                      placeholder="Email"
                    />
                    <img
                      anima-src="./img/homeline.png"
                      className="af-class-bp2-line"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </div>
                  <div className="af-class-bp2-view16">
                    <div className="af-class-bp2-rectangle3"></div>
                    <textarea
                      className="af-class-bp2-text-how-can-i-help"
                      name="textHowCanIHelp"
