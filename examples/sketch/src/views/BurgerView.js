            ...
            >
              <div className="af-class-content">
                ...
                <div className="af-class-x-mlid1517">
                  <img
                    anima-src="./img/burgerxmlid218.png"
                    className="af-class-x-mlid218"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  <div className="af-class-x-mlid374">
                    <img
                      anima-src="./img/burgerxmlid414.png"
                      className="af-class-x-mlid414"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <div className="af-class-x-mlid412">
                      <img
                        anima-src="./img/burgerxmlid413.png"
                        className="af-class-x-mlid413"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                      />
                    </div>
                    <img
                      anima-src="./img/burgerxmlid411.png"
                      className="af-class-x-mlid411"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </div>
                  <div className="af-class-x-mlid136">
                    <img
                      anima-src="./img/burgerxmlid373.png"
                      className="af-class-x-mlid373"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </div>
                  <img
                    anima-src="./img/burgerxmlid135.png"
                    className="af-class-x-mlid135"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  <img
                    anima-src="./img/burgerxmlid116.png"
                    className="af-class-x-mlid116"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  <img
                    anima-src="./img/burgerxmlid115.png"
                    className="af-class-x-mlid115"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  <div className="af-class-x-mlid106">
                    <div className="af-class-x-mlid111">
                      <img
                        anima-src="./img/burgerxmlid114.png"
                        className="af-class-x-mlid114"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                      />
                      <img
                        anima-src="./img/burgerxmlid113.png"
                        className="af-class-x-mlid113"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                      />
                      <img
                        anima-src="./img/burgerxmlid112.png"
                        className="af-class-x-mlid112"
                        src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                      />
                    </div>
                    <img
                      anima-src="./img/burgerxmlid110.png"
                      className="af-class-x-mlid110"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <img
                      anima-src="./img/burgerxmlid109.png"
                      className="af-class-x-mlid109"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <img
                      anima-src="./img/burgerxmlid108.png"
                      className="af-class-x-mlid108"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                    <img
                      anima-src="./img/burgerxmlid107.png"
                      className="af-class-x-mlid107"
                      src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                    />
                  </div>
                </div>
