          ...
          <div className="af-class-cow">
            ...
            >
              <div className="af-class-x-mlid1987">
                <img
                  anima-src="./img/cowxmlid2793.png"
                  className="af-class-x-mlid2793"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2792.png"
                  className="af-class-x-mlid2792"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2791.png"
                  className="af-class-x-mlid2791"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2790.png"
                  className="af-class-x-mlid2790"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2789.png"
                  className="af-class-x-mlid2789"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2788.png"
                  className="af-class-x-mlid2788"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2787.png"
                  className="af-class-x-mlid2787"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2786.png"
                  className="af-class-x-mlid2786"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2785.png"
                  className="af-class-x-mlid2785"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid992.png"
                  className="af-class-x-mlid992"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid991.png"
                  className="af-class-x-mlid991"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid865.png"
                  className="af-class-x-mlid865"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2781.png"
                  className="af-class-x-mlid2781"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2780.png"
                  className="af-class-x-mlid2780"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2779.png"
                  className="af-class-x-mlid2779"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2778.png"
                  className="af-class-x-mlid2778"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2777.png"
                  className="af-class-x-mlid2777"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2776.png"
                  className="af-class-x-mlid2776"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2775.png"
                  className="af-class-x-mlid2775"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2774.png"
                  className="af-class-x-mlid2774"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2774.png"
                  className="af-class-x-mlid2773"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2771.png"
                  className="af-class-x-mlid2772"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2771.png"
                  className="af-class-x-mlid2771"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2769.png"
                  className="af-class-x-mlid2770"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <img
                  anima-src="./img/cowxmlid2769.png"
                  className="af-class-x-mlid2769"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
              </div>
              <div className="af-class-content">
                <div className="af-class-titre">
                  <img
                    anima-src="./img/cowsubtitle.png"
                    className="af-class-subtitle"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  <img
                    anima-src="./img/burgertitle.png"
                    className="af-class-title"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                </div>
                <img
                  anima-src="./img/cowlorem ipsum dolor si.png"
                  className="af-class-lorem-ipsum-dolor-si"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
              </div>
              {map(proxies["close"], (props) => (
                <img
                  anima-src="./img/burgericonclose.svg"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  {...{
                    ...props,
                    className: `af-class-icon-close ${props.className || ""}`,
                  }}
                >
                  {props.children ? (
                    props.children
