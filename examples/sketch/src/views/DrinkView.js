            ...
            >
              <div className="af-class-content">
                <div className="af-class-titre">
                  <img
                    anima-src="./img/drinksubtitle.png"
                    className="af-class-subtitle"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  <img
                    anima-src="./img/drinktitle.png"
                    className="af-class-title"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                </div>
                <img
                  anima-src="./img/drinklorem ipsum dolor si.png"
                  ...
                  {props.children ? (
                    ...
                    <React.Fragment>
                      <div className="af-class-x-mlid1219">
                        <img
                          anima-src="./img/drinkxmlid1253.png"
                          className="af-class-x-mlid1253"
                          src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                        />
                        <div className="af-class-x-mlid1163">
                          <img
                            anima-src="./img/drinkxmlid1213.png"
                            className="af-class-x-mlid1213"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                          />
                          <div className="af-class-x-mlid1202">
                            <div className="af-class-x-mlid1208">
                              <img
                                anima-src="./img/drinkxmlid1212.png"
                                className="af-class-x-mlid1212"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                              <img
                                anima-src="./img/drinkxmlid1211.png"
                                className="af-class-x-mlid1211"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                              <img
                                anima-src="./img/drinkxmlid1210.png"
                                className="af-class-x-mlid1210"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                              <img
                                anima-src="./img/drinkxmlid1209.png"
                                className="af-class-x-mlid1209"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                            </div>
                            <div className="af-class-x-mlid1203">
                              <img
                                anima-src="./img/drinkxmlid1207.png"
                                className="af-class-x-mlid1207"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                              <img
                                anima-src="./img/drinkxmlid1206.png"
                                className="af-class-x-mlid1206"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                              <img
                                anima-src="./img/drinkxmlid1205.png"
                                className="af-class-x-mlid1205"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                              <img
                                anima-src="./img/drinkxmlid1204.png"
                                className="af-class-x-mlid1204"
                                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                              />
                            </div>
                          </div>
                          <div className="af-class-x-mlid1190">
                            <div className="af-class-x-mlid1201"></div>
                            <img
                              anima-src="./img/drinkxmlid1200.png"
                              className="af-class-x-mlid1200"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <img
                              anima-src="./img/drinkxmlid1199.png"
                              className="af-class-x-mlid1199"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <div className="af-class-x-mlid1198"></div>
                            <img
                              anima-src="./img/drinkxmlid1197.png"
                              className="af-class-x-mlid1197"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <img
                              anima-src="./img/drinkxmlid1196.png"
                              className="af-class-x-mlid1196"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <div className="af-class-x-mlid1195"></div>
                            <img
                              anima-src="./img/drinkxmlid1194.png"
                              className="af-class-x-mlid1194"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <img
                              anima-src="./img/drinkxmlid1196.png"
                              className="af-class-x-mlid1193"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <img
                              anima-src="./img/drinkxmlid1192.png"
                              className="af-class-x-mlid1192"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                            <img
                              anima-src="./img/drinkxmlid1191.png"
                              className="af-class-x-mlid1191"
                              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                            />
                          </div>
                          <img
                            anima-src="./img/drinkxmlid1165.png"
                            className="af-class-x-mlid1165"
                            src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                          />
                        </div>
                      </div>
