      ...
      <span>
        ...
        <span className="af-view">
          ...
          <div className="af-class-bp1-project-page-mobile">
            <img
              anima-src="./img/project page mobilerectangle.png"
              className="af-class-bp1-rectangle"
            ...
            <div className="af-class-bp1-centered-layout-container">
              <div className="af-class-bp1-centered">
                <div className="af-class-bp1-a-hamburger-or-burge bp1-an-animation-enter13 ">
                  A hamburger or burger is a sandwich consisting of one or more
                  cooked patties of ground meat, usually beef, placed inside a
                  sliced bread roll or bun. The patty may be pan fried,
                  barbecued, or flame broiled. Hamburgers are often served with
                  cheese, lettuce, tomato, bacon, onion, pickles, or chiles;
                  condiments such as mustard, mayonnaise, ketchup, relish, or
                  "special sauce"; and are frequently placed on sesame seed
                  buns. A hamburger topped with cheese is called a cheeseburger.
                  <br />
                  <br />- Wikipedia
                </div>
                <a
                  href="https://www.sketchappsources.com/contributor/alexisdoreau"
                  target="_blank"
                >
                ...
                <a
                  href="https://www.sketchappsources.com/contributor/webalys"
                  target="_blank"
                >
                ...
                <div className="af-class-bp1-mockup-layout-container">
                  <img
                    anima-src="./img/project page mobilemockup@2x.png"
                    className="af-class-bp1-mockup bp1-an-animation-enter16 "
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                </div>
            ...
            <a href="javascript:animaShowOverlay('menuoverlay', 'bp1-an-animation-enter19'); anima_loadAsyncSrc(); ">
              <img
                ...
                className="af-class-bp1-menu-button bp1-an-animation-enter18 "
                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
              />
            </a>
          </div>
          <div className="af-class-bp2-project-page">
            <img
              anima-src="./img/project pagerectangle.png"
              className="af-class-bp2-rectangle"
              src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
            />
            <div className="af-class-bp2-phone"></div>
            <div className="af-class-bp2-centered-layout-container">
              <div className="af-class-bp2-centered">
                ...
                <img
                  anima-src="./img/project pagemockup@2x.png"
                  className="af-class-bp2-mockup bp2-an-animation-enter16 "
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
            ...
            <a href="javascript:animaShowOverlay('menuoverlay', 'bp2-an-animation-enter19'); anima_loadAsyncSrc(); ">
              <img
                anima-src="./img/project page mobilemenubutton@2x.png"
                className="af-class-bp2-menu-button bp2-an-animation-enter18 "
                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
              />
            </a>
          </div>
          <div
            className="anima-overlay"
            id="overlay-menuoverlay"
            style={{ minHeight: 762 }}
          >
            <a href="javascript:animaHideOverlay('menuoverlay', 'anima-animate-disappear');"></a>
            <div className="af-class-menu-overlay">
              <a href="javascript:animaHideOverlay('menuoverlay', 'anima-animate-disappear');"></a>
              <a href="javascript:animaHideOverlay('menuoverlay', 'anima-animate-disappear');">
                <img
                  anima-src="./img/menu overlaymenu x@2x.png"
                  className="af-class-menu-x af-class-an-animation-enter2 "
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
              </a>
              <div className="af-class-stacked-group-layout-container">
                ...
                <div className="af-class-stacked-group af-class-an-animation-enter3 ">
                  <a href="javascript:animaHideOverlay('menuoverlay', 'anima-animate-disappear');"></a>
                  <a href="home.html">
                    <div className="af-class-home">Home</div>
                  </a>
                  ...
                  <a
                    href="https://animaapp.s3.amazonaws.com/medium/portfolio-template/Portfolio%20Sample.sketch"
                    target="_blank"
                  >
                  ...
                  <a
                    href="https://medium.com/@AnimaApp/responsive-website-template-portfolio-d9759dd78c24"
                    target="_blank"
                  >
