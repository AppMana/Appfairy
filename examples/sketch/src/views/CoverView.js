...
class CoverView extends React.Component {
  ...
  render() {
    const proxies =
      Controller !== CoverView ? transformProxies(this.props.children) : {};
          ...
          <div className="af-class-cover">
            ...
            >
              <div className="af-class-header">
                <div className="af-class-cover-bg"></div>
                <img
                  anima-src="./img/covercover image.jpg"
                  className="af-class-cover-image"
                  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                />
                <div className="af-class-hello-box af-class-an-animation-enter ">
                  <div className="af-class-background"></div>
                  <img
                    anima-src="./img/covercorner@2x.png"
                    className="af-class-corner"
                    src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
                  />
                  ...
                  <div className="af-class-i-m">I'M</div>
                </div>
              </div>
              ...
              <img
                anima-src="./img/coverbitmap.png"
                className="af-class-bitmap"
                src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="
              />
            </div>
          </div>
