      ...
      <div>
        ...
        <div id="contact" className="__af-section-3 __af-thanks">
          <div className="__af-container-2 __af-thank-you __af-w-container">
            {proxies["message"] && (
              <h1 className="__af-heading-3 __af-ty" {...proxies["message"]}>
                {proxies["message"].children ? (
                  proxies["message"].children
                ) : (
                  <React.Fragment>Thank You!</React.Fragment>
                )}
              </h1>
            )}
            <p className="__af-paragraph-3">
              We have received your enquiry. Someone from our team will get back
