...
export const transpile = async (config) => {
  ...
  console.log(`Processing ${path.relative(".", config.input)} ...`);
  ...
  const encapsulatingFiles = Promise.all(
  ...
  await Promise.all([writingFiles, encapsulatingFiles]);
